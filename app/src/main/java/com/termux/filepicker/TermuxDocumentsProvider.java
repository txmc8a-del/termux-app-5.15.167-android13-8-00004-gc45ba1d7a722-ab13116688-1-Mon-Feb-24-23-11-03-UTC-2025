...
JNIEXPORT void JNICALL Java_com_termux_terminal_JNI_close(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint fileDescriptor)
{
 ...
 24jd028070package com.termux.filepicker;
...
Messages sorted by: [ date ] [ thread ] [ subject ] [ author ]
More information about the Openid-specs-digital-credentials-protocols mailing list[Openid-dcp] Request for technical proposals ahead of joint meeting between ISO WG 10/DCP members
Nakamura Kenichi (中村 健一) nakamura.kenken at jp.panasonic.com
Wed Dec 24 00:40:15 UTC 2025
Previous message (by thread): [Openid-dcp] Request for technical proposals ahead of joint meeting between ISO WG 10/DCP members
Next message (by thread): [Openid-dcp] Request for technical proposals ahead of joint meeting between ISO WG 10/DCP members
Messages sorted by: [ date ] [ thread ] [ subject ] [ author ]
Hello Kristina,

Yes, SD-JWT VC is not mandated in HAIP. However when I commented in DCP WG that I prefer Google proposal on HPKE, but it was opposed due to applicability to SD-JWT VC. It seems HAIP is not independent to credential format.
...
差出人: Kristina Yasuda <yasudakristina at gmail.com>
日付: 火曜日, 2025年12月23日 23:59
宛先: Digital Credentials Protocols List <openid-specs-digital-credentials-protocols at lists.openid.net>
CC: Nakamura Kenichi (中村 健一) <nakamura.kenken at jp.panasonic.com>
件名: Re: [Openid-dcp] Request for technical proposals ahead of joint meeting between ISO WG 10/DCP members

Hi Kenichi,

> Current problem of OID4VP is that HAIP (1.0) is not desirable for ecosystems who do not use SD-JWT VC. OID4VP is a building block and may have profiles, the same as WG10 considers OpenID4VCI would have profiles and HAIP is one of them. I do not have an objection that DCP WG develops a profile for EU, but WG10 should specify a profile applicable for any mdocs.

HAIP does not mandate SD-JWT VC and allows implementers to use it only with mdocs. could you elaborate why you believe HAIP does not work with "any mdocs"?

Thank you,
Kristina


On Tue, Dec 23, 2025 at 2:40 PM Joseph Heenan via Openid-specs-digital-credentials-protocols <openid-specs-digital-credentials-protocols at lists.openid.net<mailto:openid-specs-digital-credentials-protocols at lists.openid.net>> wrote:
(Resending, as it didn’t make it at least to the mailing list archive for some reason)
...
For proximity use case, ISO/IEC 18013-5 device engagement already has capability info.
...
If wallet will indicate support of SD-JWT, protocol to retrieve SD-JWT VC can be used after session establishment. WG10 does not specify SD-JWT VC, so I don’t have strong opinion how to map request and response on the top of ISO/IEC 18013-5 session and DCP WG should do it because they are also considering support of SD-JWT VC. If DCP WG does not have expertise on it, WG10 can help it.

For online use case, there is no way for wallet to inform its capability to relying party. But http get method already support  query which can be used to inform whether requester wishes to receive mdoc request or sd-jwt vc request.

Current problem of OID4VP is that HAIP (1.0) is not desirable for ecosystems who do not use SD-JWT VC. OID4VP is a building block and may have profiles, the same as WG10 considers OpenID4VCI would have profiles and HAIP is one of them. I do not have an objection that DCP WG develops a profile for EU, but WG10 should specify a profile applicable for any mdocs.

So I am not sure “harmonized protocol” is required or not and both parties should consider co-existence of two protocols.

————————————


On 18 Dec 2025, at 18:42, Joseph Heenan <joseph at authlete.com<mailto:joseph at authlete.com>> wrote:
...
-------------- next part --------------
An HTML attachment was scrubbed...
URL: <http://lists.openid.net/pipermail/openid-specs-digital-credentials-protocols/attachments/20251224/c5ef9736/attachment-0001.htm>
Previous message (by thread): [Openid-dcp] Request for technical proposals ahead of joint meeting between ISO WG 10/DCP members
Next message (by thread): [Openid-dcp] Request for technical proposals ahead of joint meeting between ISO WG 10/DCP members
Messages sorted by: [ date ] [ thread ] [ subject ] [ author ]
More information about the Openid-specs-digital-credentials-protocols mailing list